...
public class gps extends AppCompatActivity {
    ...
    private void checkLocationSetting() {
        ...
        settingsClient.checkLocationSettings(builder.build())
                ...
                .addOnFailureListener(gps.this, new OnFailureListener() {
                    @Override
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                try {
                                    ...
                                    rae.startResolutionForResult(gps.this, GPS_UTIL_LOCATION_RESOLUTION_REQUEST_CODE);
    ...
    private LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            Log.d("CB check", "Location Callback is called!");
            txvLa.setText("La : " + latitude);
            txvLo.setText("Lo : " + longitude);
...
//            finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backMain = findViewById(R.id.bckmain);
        getGps = findViewById(R.id.gps);
        txvLa = findViewById(R.id.La);
        txvLo = findViewById(R.id.Lo);
